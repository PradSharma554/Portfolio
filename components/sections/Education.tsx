    ...
    <section className="py-16 px-4 md:px-10 relative overflow-hidden">
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="mb-12">
          ...
          <h3 className="text-4xl md:text-6xl font-bold font-space text-white">Academic Journey</h3>
        </div>
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                ...
                <div className="flex items-center gap-2 bg-purple-500/10 px-4 py-2 rounded-lg border border-purple-500/20 w-fit">
                  ...
                  <span className="text-sm font-mono text-purple-300">{edu.period}</span>
                </div>
              </div>
              <div className="pt-4 border-t border-white/10">
                <p className="text-gray-300">{edu.cgpa ? `CGPA: ${edu.cgpa}` : edu.marks}</p>
              </div>
            </div>
          ))}
        </div>
